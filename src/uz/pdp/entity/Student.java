...
public class Student implements Serializable  {
    ...
    public Student(Integer id, String firstName, String lastName, Integer phoneNumber, LocalDate birthDate, Group group, Address address, String biographyFilePath) {
        this.id = id;
